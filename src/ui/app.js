import { initStateService, stateService } from '/core/client/state/state-service-factory.js';
import { runSession } from '/core/client/session-service.js';
import { reportResults } from '/core/client/report-service.js';
import { EVENT, SUITE_OPTIONS_DEFAULT, TEST_OPTIONS_DEFAULT } from '/core/common/constants.js';
import { getTestId, getValidName, parseTestId } from '/core/common/interop-utils.js';
