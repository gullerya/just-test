/**
 * This service executes tests as running in browser environment
 */
...
async function execute() {
	//	get all tests data and metadata
	//	build tests execution plan
	//	execute
	//	watch for all of the tests to finish
}
