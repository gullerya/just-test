...
async function main() {
	const environmentService = new EnvironmentService(givenConfig.environments, givenConfig.clArguments);
	const environments = environmentService.environments;
	const allEnvsReady = [];

	//	init tester - one for all
	const testsService = new TestsService(givenConfig.tests, givenConfig.clArguments);

	//	init server - one for all
	const serverService = new ServerService(givenConfig.server, givenConfig.clArguments);
